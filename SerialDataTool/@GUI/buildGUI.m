function buildGUI(obj)
    ...
    obj.dd_selPort = uidropdown(obj.fig,...
            ...
            'Items', serialportlist('available'),...
    ...
    obj.dd_showASCII = uidropdown(obj.fig,...
            ...
            'Items', {'HEX', 'ASCII','DEC'},...
            'ItemsData', [2, 3, 1],...
            'ValueChangedFcn',@obj.evt_dd_showAsciiCBF);
    ...
    obj.cb_scrollBottom = uicheckbox(obj.fig,...
           'Text','Autoscroll',...
           'Value',1,...
           'Position',[[340,315,100,25]]  )
    ...
    obj.dd_selSignalFile = uidropdown(obj.fig,...
            'Position',[630 350 180 25],...
            'Items', {obj.signalFileListing.name});
        
    obj.btn_clearPlotter = uibutton(obj.fig,...
            'Position',[820,350,100,25],...
            'Text','show Send Data',...
            'Enable',1);  
    ...
    obj.btn_recordData = uibutton(obj.fig, ...
            'Position',[520,10,100,25],...
            'Text','Record Data',...
            'Enable',1,...
            'ButtonPushedFcn', @obj.evt_btn_recordDataCBF);
    
    obj.txa_inputFileName = uieditfield (obj.fig, ...
            'Position',[630,10,180,25], ...
